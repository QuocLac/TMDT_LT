...
namespace TMDT_LT.Controllers
{
    ...
    public class StoreController : Controller
    {
        ...
        public StoreController(ApplicationDbContext context, ICrossSellAprioriService crossSellAprioriService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Product(int id)
        {
            ...
            // ====================================================================
            var aprioriCrossSellProducts = await _crossSellAprioriService.GetRecommendationsForProductAsync(
                product.ProductId,
                excludedProductIds: new[] { product.ProductId },
                contextProductIds: new[] { product.ProductId });
            ...
            {
                Product = product,
                AprioriCrossSellProducts = aprioriCrossSellProducts,
