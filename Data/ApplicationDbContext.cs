...
public partial class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<SalesOrderDetails>()
            .Property(p => p.TaxRate).HasColumnType("decimal(18,2)");
        modelBuilder.Entity<SalesOrderDetails>()
        ...
        modelBuilder.Entity<SalesOrders>()
            .Property(p => p.COGSTotal).HasColumnType("decimal(18,2)");
        modelBuilder.Entity<SalesOrders>()
            .Property(p => p.DiscountAmount).HasColumnType("decimal(18,2)");
        modelBuilder.Entity<SalesOrders>()
            .Property(p => p.DiscountPercent).HasColumnType("decimal(18,2)");
        modelBuilder.Entity<SalesOrders>()
            .Property(p => p.ProfitTotal).HasColumnType("decimal(18,2)");
        modelBuilder.Entity<SalesOrders>()
        ...
        modelBuilder.Entity<SalesOrders>(entity => {
            ...
            entity.HasOne(d => d.Store).WithMany(p => p.SalesOrders).HasForeignKey(d => d.StoreId);
        });

        modelBuilder.Entity<SalesOrderDetails>(entity => {
            entity.HasKey(e => e.SODetailId); // ĐÃ SỬA: Chữ chính xác không còn ký tự lạ
        ...
        modelBuilder.Entity<Address>(entity =>
        {
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.Address)
                .HasForeignKey(d => d.CustomerId).HasConstraintName("FK__ADDRESS__Custome__4CA06362");
        });
        ...
        modelBuilder.Entity<CartItems>(entity =>
        {
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.CartItems)
                .HasForeignKey(d => d.CustomerId).OnDelete(DeleteBehavior.Cascade).HasConstraintName("FK__CartItems__Custo__628FA481");
            entity.HasOne(d => d.Variant).WithMany(p => p.CartItems)
                .HasForeignKey(d => d.VariantId).OnDelete(DeleteBehavior.Cascade).HasConstraintName("FK__CartItems__Varia__6383C8BA");
        });
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.Property(e => e.CustomerId).HasColumnName("CustomerID");
            entity.Property(e => e.AccountId).HasColumnName("AccountID");
            entity.Property(e => e.CustomerType).HasMaxLength(20).HasDefaultValue("Thường");
            entity.Property(e => e.FullName).HasMaxLength(100);
            entity.Property(e => e.Gender).HasMaxLength(10).HasDefaultValue("Nam");
            entity.Property(e => e.Phone).HasMaxLength(15);
            entity.HasOne(d => d.Account).WithMany(p => p.Customer)
                .HasForeignKey(d => d.AccountId).HasConstraintName("FK__CUSTOMER__Accoun__47DBAE45");
        });
        ...
        modelBuilder.Entity<FavoriteDetails>(entity =>
        {
            ...
            entity.HasOne(d => d.Favorite).WithMany(p => p.FavoriteDetails)
                .HasForeignKey(d => d.FavoriteId).OnDelete(DeleteBehavior.Cascade).HasConstraintName("FK__FavoriteD__Favor__6A30C649");
            entity.HasOne(d => d.Variant).WithMany(p => p.FavoriteDetails)
                .HasForeignKey(d => d.VariantId).OnDelete(DeleteBehavior.Cascade).HasConstraintName("FK__FavoriteD__Varia__6B24EA82");
        });
        ...
        modelBuilder.Entity<Favorites>(entity =>
        {
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.Favorites)
                .HasForeignKey(d => d.CustomerId).OnDelete(DeleteBehavior.Cascade).HasConstraintName("FK__Favorites__Custo__6754599E");
        });
        ...
        modelBuilder.Entity<InventoryTransactions>(entity =>
        {
            ...
            entity.HasOne(d => d.Account).WithMany(p => p.InventoryTransactions)
                .HasForeignKey(d => d.AccountId).HasConstraintName("FK__Inventory__Accou__0F624AF8");
            entity.HasOne(d => d.Variant).WithMany(p => p.InventoryTransactions)
                .HasForeignKey(d => d.VariantId).OnDelete(DeleteBehavior.Cascade).HasConstraintName("FK__Inventory__Varia__0E6E26BF");
        });
        ...
        modelBuilder.Entity<Notifications>(entity =>
        {
            ...
            entity.HasOne(d => d.Account).WithMany(p => p.Notifications)
                .HasForeignKey(d => d.AccountId).OnDelete(DeleteBehavior.Cascade).HasConstraintName("FK__Notificat__Accou__5165187F");
        });
        ...
        modelBuilder.Entity<OrderDetails>(entity =>
        {
            ...
            entity.HasOne(d => d.Order).WithMany(p => p.OrderDetails)
                .HasForeignKey(d => d.OrderId).OnDelete(DeleteBehavior.Cascade).HasConstraintName("FK__OrderDeta__Order__72C60C4A");
            entity.HasOne(d => d.Variant).WithMany(p => p.OrderDetails)
                .HasForeignKey(d => d.VariantId).HasConstraintName("FK__OrderDeta__Varia__73BA3083");
        });
        ...
        modelBuilder.Entity<Orders>(entity =>
        {
            ...
            entity.Property(e => e.ShippingCountry).HasMaxLength(100).HasDefaultValue("Việt Nam");
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.Orders)
                .HasForeignKey(d => d.CustomerId).HasConstraintName("FK__Orders__Customer__6FE99F9F");
        });
        ...
        modelBuilder.Entity<Payments>(entity =>
        {
            ...
            entity.HasOne(d => d.Order).WithMany(p => p.Payments)
                .HasForeignKey(d => d.OrderId).OnDelete(DeleteBehavior.Cascade).HasConstraintName("FK__Payments__OrderI__76969D2E");
        });
        ...
        modelBuilder.Entity<ProductVariants>(entity =>
        {
            ...
            entity.Property(e => e.Ram).HasMaxLength(20).HasColumnName("RAM");
            entity.Property(e => e.Stock).HasDefaultValue(0);
            entity.Property(e => e.Storage).HasMaxLength(20);
            entity.Property(e => e.UpdatedDate).HasColumnType("datetime");
            entity.HasOne(d => d.Product).WithMany(p => p.ProductVariants)
                .HasForeignKey(d => d.ProductId).HasConstraintName("FK__ProductVa__Produ__5DCAEF64");
        });
        ...
        modelBuilder.Entity<Products>(entity =>
        {
            ...
            entity.HasOne(d => d.Brand).WithMany(p => p.Products)
                .HasForeignKey(d => d.BrandId).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK__Products__BrandI__571DF1D5");
            entity.HasOne(d => d.Category).WithMany(p => p.Products)
                .HasForeignKey(d => d.CategoryId).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK__Products__Catego__5812160E");
        });
        ...
        modelBuilder.Entity<PurchaseOrderDetails>(entity =>
        {
            ...
            entity.HasOne(d => d.Po).WithMany(p => p.PurchaseOrderDetails)
                .HasForeignKey(d => d.Poid).OnDelete(DeleteBehavior.Cascade).HasConstraintName("FK__PurchaseOr__POId__09A971A2");
            entity.HasOne(d => d.Variant).WithMany(p => p.PurchaseOrderDetails)
                .HasForeignKey(d => d.VariantId).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK__PurchaseO__Varia__0A9D95DB");
        });
        ...
        modelBuilder.Entity<PurchaseOrders>(entity =>
        {
            ...
            entity.Property(e => e.AccountId).HasColumnName("AccountID");
            entity.Property(e => e.OrderDate).HasDefaultValueSql("(getdate())").HasColumnType("datetime");
            entity.Property(e => e.Status).HasMaxLength(50).HasDefaultValue("Hoàn thành");
            entity.Property(e => e.TotalAmount).HasColumnType("decimal(18, 2)");
            entity.HasOne(d => d.Account).WithMany(p => p.PurchaseOrders)
                .HasForeignKey(d => d.AccountId).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK__PurchaseO__Accou__06CD04F7");
            entity.HasOne(d => d.Supplier).WithMany(p => p.PurchaseOrders)
                .HasForeignKey(d => d.SupplierId).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK__PurchaseO__Suppl__05D8E0BE");
        });
