...
public partial class ApplicationDbContext : DbContext
{
    ...
    public virtual DbSet<CrossSellSettings> CrossSellSettings { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // ==========================================
        // APRIORI CROSS-SELL SETTINGS
        // ==========================================
        modelBuilder.Entity<CrossSellSettings>(entity =>
        {
            entity.HasKey(e => e.CrossSellSettingsId);
            entity.ToTable("CrossSellSettings");
            entity.Property(e => e.IsEnabled).HasDefaultValue(true);
            entity.Property(e => e.MinSupportCount).HasDefaultValue(2);
            entity.Property(e => e.MinSupportPercent).HasColumnType("decimal(5,4)").HasDefaultValue(0m);
            entity.Property(e => e.MinConfidence).HasColumnType("decimal(5,4)").HasDefaultValue(0.2m);
            entity.Property(e => e.MinLift).HasColumnType("decimal(8,4)").HasDefaultValue(1m);
            entity.Property(e => e.MaxItemsetSize).HasDefaultValue(3);
            entity.Property(e => e.MaxRecommendationsPerProduct).HasDefaultValue(6);
            entity.Property(e => e.AnalysisWindowDays).HasDefaultValue(365);
            entity.Property(e => e.OnlyCompletedOrders).HasDefaultValue(true);
            entity.Property(e => e.AllowedOrderStatuses).HasMaxLength(500).HasDefaultValue("Đã hoàn thành,Hoàn thành,Đã giao,Completed");
            entity.Property(e => e.ExcludeOutOfStock).HasDefaultValue(true);
            entity.Property(e => e.AllowFallbackWhenNoRule).HasDefaultValue(false);
            entity.Property(e => e.IsBundleDiscountEnabled).HasDefaultValue(false);
            entity.Property(e => e.BundleDiscountType).HasDefaultValue(0);
            entity.Property(e => e.BundleDiscountValue).HasColumnType("decimal(18,2)").HasDefaultValue(0m);
            entity.Property(e => e.BundleDiscountLabel).HasMaxLength(120).HasDefaultValue("Ưu đãi mua kèm");
            entity.Property(e => e.UpdatedAt).HasColumnType("datetime");
            entity.HasData(new CrossSellSettings
            {
                ...
                UpdatedAt = new DateTime(2026, 7, 6)
            });
        });
